...
export function activate(context: vscode.ExtensionContext) {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('arc.startBridge', startBridge),
        vscode.commands.registerCommand('arc.stopBridge', stopBridge),
        vscode.commands.registerCommand('arc.openDashboard', openDashboard),
        vscode.commands.registerCommand('arc.showStatus', showStatus)
    );
...
// API Handlers
function handleRead(url: URL, res: http.ServerResponse, root: string) {
...
function handleList(url: URL, res: http.ServerResponse, root: string) {
...
function handleWrite(req: http.IncomingMessage, res: http.ServerResponse, root: string) {
    let body = '';
...
function handleExec(req: http.IncomingMessage, res: http.ServerResponse, root: string) {
    let body = '';
    req.on('data', chunk => body += chunk);
    req.on('end', () => {
        try {
...
function handleStatus(res: http.ServerResponse, root: string) {
...
function serveUI(res: http.ServerResponse) {
